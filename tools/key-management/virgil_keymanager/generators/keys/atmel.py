...
class AtmelAuthKeyGenerator(Atmel):

    def __init__(self, ui, atmel):
        Atmel.__init__(self, ui, atmel)
        super(AtmelAuthKeyGenerator, self).__init__(ui, atmel)
...
class AtmelFirmwareKeyGenerator(Atmel):

    def __init__(self, ui, atmel):
        Atmel.__init__(self, ui, atmel)
        super(AtmelFirmwareKeyGenerator, self).__init__(ui, atmel)
...
class AtmelSDMPDKeyGenerator(Atmel):
...
class AtmelTrustListServiceKeyGenerator(Atmel):
