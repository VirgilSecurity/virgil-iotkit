...
from soraa_keymanager.generators.keys.abstract.firmware_key import FirmwareKeyGenerator
from .atmel import Atmel


class AtmelFirmwareKeyGenerator(Atmel, FirmwareKeyGenerator):
