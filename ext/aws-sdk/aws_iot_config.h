...
//#define AWS_IOT_MQTT_HOST              "a2fosbwc4dwk0v.iot.us-west-2.amazonaws.com"
//#define AWS_IOT_MQTT_PORT              8883
//#define AWS_IOT_MQTT_CLIENT_ID         "myTestThings"
//#define AWS_IOT_MY_THING_NAME          "myTestThings"
//#define AWS_IOT_ROOT_CA_FILENAME      "root-CA.crt"
//#define AWS_IOT_CERTIFICATE_FILENAME   "3a9b731d9e-certificate.pem.crt"
//#define AWS_IOT_PRIVATE_KEY_FILENAME   "3a9b731d9e-private.pem.key"
/*
#define AWS_IOT_MQTT_HOST              "a2fosbwc4dwk0v.iot.us-west-2.amazonaws.com"
#define AWS_IOT_MQTT_PORT              8883
#define AWS_IOT_MQTT_CLIENT_ID         "myTestThings2"
#define AWS_IOT_MY_THING_NAME          "myTestThings2"
#define AWS_IOT_ROOT_CA_FILENAME      "root-CA.crt"
#define AWS_IOT_CERTIFICATE_FILENAME   "5b0d397f76-certificate.pem.crt"
#define AWS_IOT_PRIVATE_KEY_FILENAME   "5b0d397f76-private.pem.key"
*/
/*
#define AWS_IOT_MQTT_HOST              "a2fosbwc4dwk0v.iot.us-west-2.amazonaws.com"
#define AWS_IOT_MQTT_PORT              8883
#define AWS_IOT_MQTT_CLIENT_ID         "myHomeThing1"
#define AWS_IOT_MY_THING_NAME          "myHomeThing1"
#define AWS_IOT_ROOT_CA_FILENAME      "root-CA.crt"
#define AWS_IOT_CERTIFICATE_FILENAME   "efc098a159-certificate.pem.crt"
#define AWS_IOT_PRIVATE_KEY_FILENAME   "efc098a159-private.pem.key"
*/
#define AWS_IOT_MQTT_HOST              "a2fosbwc4dwk0v.iot.us-west-2.amazonaws.com"
#define AWS_IOT_MQTT_PORT              8883
#define AWS_IOT_MQTT_CLIENT_ID         "myHomeThing2"
#define AWS_IOT_MY_THING_NAME          "myHomeThing2"
#define AWS_IOT_ROOT_CA_FILENAME       "root-CA.crt"
#define AWS_IOT_CERTIFICATE_FILENAME   "88b28076eb-certificate.pem.crt"
#define AWS_IOT_PRIVATE_KEY_FILENAME   "88b28076eb-private.pem.key"

#define _ENABLE_THREAD_SUPPORT_
// =================================================

// MQTT PubSub
#define AWS_IOT_MQTT_TX_BUF_LEN (4 * 1024) ///< Any time a message is sent out through the MQTT layer. The message is copied into this buffer anytime a publish is done. This will also be used in the case of Thing Shadow
#define AWS_IOT_MQTT_RX_BUF_LEN (4 * 1024) ///< Any message that comes into the device should be less than this buffer size. If a received message is bigger than this buffer size the message will be dropped.
...
#define MAX_SHADOW_TOPIC_LENGTH_WITHOUT_THINGNAME 160 ///< All shadow actions have to be published or subscribed to a topic which is of the format $aws/things/{thingName}/shadow/update/accepted. This refers to the size of the topic without the Thing Name
#define MAX_SIZE_OF_THING_NAME 64 ///< The Thing Name should not be bigger than this value. Modify this if the Thing Name needs to be bigger
