...
- **Crypto Module. Connect any crypto library and hard secure module (SECMODULE)**. Virgil IoTKit provides flexible and simple API for any types of crypto library and SECMODULE. At the same time, the framework provides default software SECMODULE implementation based on Virgil Crypto. (Support for ATECC608A and ATECC508A in the next version).
